...
def main():
    ...
    for label, model_path in model_paths_with_labels:
        ...
        # selected_wavelengths = ['_445nm', '_445nm', '_515nm', '_555nm', '_560nm', '_610nm', '_680nm', '_730nm', '_900nm', '_940nm'] # for API (SNV + manh + BR / SNV + BR) -
        # selected_wavelengths = ['_415nm', '_445nm', '_515nm', '_555nm', '_560nm', '_610nm', '_680nm', '_730nm', '_900nm', '_940nm'] # for API (SNV + euc + BR)
        # selected_wavelengths = ['445 nm', '515 nm', '555 nm', '560 nm', '585 nm', '610 nm', '680 nm', '730 nm', '900 nm', '940 nm'] # for CSV (SNV + BR) - old
        selected_wavelengths = ['445 nm', '_445nm', '515 nm', '555 nm', '560 nm', '610 nm', '680 nm', '730 nm', '900 nm', '940 nm'] # for CSV (SNV + BR) - new
