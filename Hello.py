...
def main():
    ...
    # Plotting
    plt.figure(figsize=(10, 4))
    plt.plot(wavelengths, absorbance_snv_df.iloc[0], marker='o', linestyle='-', color='b', label='Preprocessed sample (SNV)')
    plt.plot(wavelengths, absorbance_snv_normalized_euc_df.iloc[0], marker='d', linestyle='-', color='r', label='Preprocessed sample (SNV + norm euc)')
    plt.plot(wavelengths, absorbance_snv_normalized_euc_baseline_removed_df.iloc[0], marker='s', linestyle='-', color='g', label='Preprocessed sample (SNV + norm euc + baseline)')
