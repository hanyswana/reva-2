...
def main():
    ...
    plt.plot(wavelengths, absorbance_snv_normalized_euc_df.iloc[0], marker='d', linestyle='-', color='r', label='Preprocessed 2 sample')
    plt.plot(wavelengths, absorbance_snv_normalized_euc_baseline_removed_df.iloc[0], marker='s', linestyle='-', color='g', label='Preprocessed 3 sample')
